...
mp.set_logging_level_optix("debug")
mp.set_logging_level_py("debug")
...
# start_view = [-10, 0, 0, 10, 0, 0, 0, 0, -1, 0, -1, 0]
# views = []
# for ii in angles:
...
views = np.array([
    # [-10,   0, 0, 10,  0,  0, 0, 1, 0, 0, 0, 1],
    # [  0, 9, 0,  0, 10,  0, 2, 0, 0, 0, 0, 1],
    # [  0,   0, -10,  0,  0, 10, 1, 0, 0, 0, 1, 0],
    [-10,   0,   0, 10,  0,  0, 0, 0.125, 0, 0, 0.05, 0.05],
    # [  0, -10,   0,  0, 10,  0, 0.70710678, 0, 0.70710678, 0, 0, 1]
    ],dtype=np.float32)
...
proj_geom = mp.create_projection_geometry('cone_vec', det_rows, det_cols, views_id, detector_geometry='cylinder', detector_cylinder_radius=64)

# proj_geom = mp.create_projection_geometry('cone', 1, 1, det_rows, det_cols, ang_id, 10, 10,
#                                           detector_geometry='cylinder', detector_cylinder_radius=20)
